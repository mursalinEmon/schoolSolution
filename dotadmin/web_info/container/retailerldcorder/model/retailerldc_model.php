...
class Retailerldc_model extends Model{
    ...
    function ablitemlist($text){
        ...
        return $this->db->select("`seitem` t",array("xitemcode as itemcode,xdesc as itemdesc,xstdprice as mrp,xdp as bv,xstdcost as cost"), " zactive=1 and xcitem='All Operation' and xsource='LDC'");
    }
    ...
    function getrindt($rin){
        ...
        $conditions[]= "xrdin = ?";
        $params[]= $rin;
		return $this->db->dbselectbyparam('mlminfo','xrdin',$conditions,$params);
