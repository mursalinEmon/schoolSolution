...
class Bkashpay extends Controller{
    ...
    Logdebug::appendlog("api url: ".$curl);
    Logdebug::appendlog("request body: ".print_r($request_data, true));
    Logdebug::appendlog("api response: ".print_r($ResultArrayToken, true));
    ...
    $header=array(
         ...
         $resultdata=curl_exec($url);  //Logdebug::appendlog($resultdata);       
            ...
            Logdebug::appendlog("API Title: Create Payment");            
            Logdebug::appendlog("API URL: https://tokenized.sandbox.bka.sh/v1.2.0-beta/tokenized/checkout/create");
            Logdebug::appendlog("Request Body: ".print_r($createagreementbody, true));
            Logdebug::appendlog("Request Response: ".print_r($obj, true));
    ...
    function callback(){
        ...
        if($status=='failure'){
            ...
            $this->finalcallback(0, 'Payment Failed', Session::get('hostcallback'));
            exit;
        }        
        if($status=='cancel'){
            $this->finalcallback(0, 'Payment Canceled', Session::get('hostcallback'));
            exit;
        }      
        ...
        //     );
            ...
            Logdebug::appendlog("Execute API");
            Logdebug::appendlog("Execute Payment");            
            Logdebug::appendlog("API URL: https://tokenized.sandbox.bka.sh/v1.2.0-beta/tokenized/checkout/execute");
            Logdebug::appendlog("Request Body".print_r($request_body, true));
            Logdebug::appendlog("API Response".print_r($obj, true));
        ...
        $request_body_json = json_encode($request_body);
            ...
            Logdebug::appendlog("Query Payment API");            
            
            Logdebug::appendlog('API URL: https://tokenized.sandbox.bka.sh/v1.2.0-beta/tokenized/checkout/payment/status');
            Logdebug::appendlog("Request Body: ".print_r($request_body, true));
            Logdebug::appendlog("API Response: ".print_r($obj, true));
            //echo  $resultdata;
            ...
            Logdebug::appendlog("API Title: Search Payment API");            
            Logdebug::appendlog('API URL: https://tokenized.sandbox.bka.sh/v1.2.0-beta/tokenized/checkout/general/searchTransaction');
            Logdebug::appendlog("Request Body: ".print_r($request_body, true));
            Logdebug::appendlog("Response API: ".print_r($srcobj, true));
    ...
    //new call
    $request_data = array(
        'paymentID'=>'TR0011W71607409665346',
        'amount'=>'100',
        'trxID'=>'7L8004ETB2',
        'sku'=>'Not Applicable',
