		...
		<div class="container">
		    ...
		    <nav>
		        ...
		        <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
		            <li class="last">
		                <a class="last" href="<?php echo URL;?>"><img style="height: 50px;" class="img-fluid" src="<?php echo URL?>assets/images/DOT-SCHOOL-SOLUTION-LOGO.jpg" alt="header-logo.png"></a>
		            </li>
		            <li>
