        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    <h5 class="section__meta">Confirm OTP</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" type="text" id="otp" name="otp" placeholder="Verification Code">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="btn-box">
                                            <button id="stuconfirm" class="theme-btn">Confirm OTP</button>
