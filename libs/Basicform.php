                ...
                $('#".$dropzoneid."').dropzone ({			
                    ...
                    success: function (file, response) {
                        ...
                        myObjStr.forEach(function(resp){   
                            ...
                            $('#imglist').html('<div class=\"col-1\"><div class=\"row\"><a href=\"'+resp+'\" target=\"_blank\"><img src=".URL."public/images/uploads/homework/pdf.png alt=\"View PDF\" width=\"60\" height=\"50\">View PDF</a><a style=\"color: red\" href=\"javascript:void(0)\" onclick=\"imgdrop(\''+resp+'\')\">Remove</a></div></div>');	
                        });
                        this.removeAllFiles(true); 
                    },                    
                    removedfile: function(file) {
