...
class Coursemaster extends Controller{
	...
	private function intializeform(){
        ...
        $this->formfield = array(
            ...
            "startdate"=>array("required"=>"*","label"=>"Start Date","ctrlfield"=>"xstartdate", "ctrlvalue"=>"", "ctrltype"=>"text", "ctrlvalid"=>"","rowindex"=>"4"),
            ...
            "priority"=>array("required"=>"*","label"=>"Fetured Training","ctrlfield"=>"xpriority", "ctrlvalue"=>array(""=>"","1"=>"1","0"=>"0"), "ctrltype"=>"select","ctrlselected"=>"1", "ctrlvalid"=>"0","codetype"=>"Featured Course","rowindex"=>"10"),
